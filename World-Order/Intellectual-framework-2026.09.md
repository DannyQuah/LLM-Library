...
Tags:
  - LLM
Created: 2026.09.08.1459.Tue -- Danny Quah ( dq @ msm3u-202603.local )
title: Intellectual-framework-2026.09
---
...
Some recent publications are attached as PDFs but URLs are also available  

Quah, Danny. 2026. "Small States are the Best Bet for Keeping World at Peace", *CNA* (Wed 01 July)  
https://www.channelnewsasia.com/commentary/war-peace-power-small-states-asean-6212086  
https://www.DannyQuah.com/publications/2026-07-Danny.Quah-Peace-Small-States-Best-Bet-CNA-APP/

Quah, Danny. 2026. "Redesigning International Order for a G-Minus World", *The Diplomat* (31 Jul)  
https://www.DannyQuah.com/publications/2026-07-Danny.Quah-Redesigning-International-Order-G-Minus-World-Diplomat/  
https://thediplomat.com/2026/07/redesigning-international-order-for-a-g-minus-world/  

Quah, Danny. 2026.  "A Cooperative Advantage", *IMF Finance and Development* (Sep) pp. 24-27  
https://www.imf.org/en/publications/fandd/issues/2026/09/a-cooperative-advantage-danny-quah  
https://www.DannyQuah.com/publications/2026-09-Danny.Quah-Cooperative-Advantage-IMFFD/  

Quah, D. 2026. "The Rest of Us:  Incentives, not Power, in Rebuilding World Order", Lee Kuan Yew School of Public Policy Working Paper (May)  
https://www.DannyQuah.com/Storage/1776415301-Danny.Quah-Incentives-not-Power-World-Order.pdf  

My syllabus for PP5182 "Economic Diplomacy", that I teach at the Lee Kuan Yew School of Public Policy  
https://www.DannyQuah.com/Storage/PP5182/2026t27/PP5182-syll.pdf  

(These publications and working papers, as well as my Substack https://DannyQuah.substack.com/ give you an idea of what I'm most recently writing. Additionally, they can also be analyzed to more sharply identify my voice, my writing style, and my compositional biases.)
...
My latest research work the following questions, challenges, and propositions.  I want to go on to build further rigour and to provide econometric and other statistical evidence on the hypotheses that emerge.

1. [Position] As rules-based multilateralism retreats, states increasingly conduct geoeconomics within a world of strategic interdependence, including by weaponising asymmetric dependencies.  How, under those conditions, can nations still cooperate?
 a. To emphasise, the starting point for my work is the retreat from rules-based multilateralism.  [Position] US-China rivalry matters but, in my view, it is not the principal driving force for the current arc of the international system.
 b. [Working hypothesis] The organising principle of a successor order should be incentive, not concentrated power.
 c. [Working hypothesis] The institutional result is not another hegemon emerging to enforce world order, but an international system that can be compactly described as comprising G-minus, multilateral-enough, and pathfinder cooperation.  I will expand on the meanings of this description below.
 d. [Position] "Inadvertent cooperation", a terminology I've been using and seek to disseminate, describes how nations can cooperate without benevolence, political agreement, or shared ideology and values.
 e. [Working hypothesis] Incentive-compatible institutions allow states pursuing different objectives to generate inadvertent cooperation.  When properly embedded in pathfinder coalitions, such cooperation can be sustained without requiring consensus, benevolence, or hegemonic enforcement.  This is a version of the Adam Smith idea that "It is not from the benevolence of the butcher, brewer, or baker that we expect dinner on our table, but instead from their regard to their self-interest."
2. [Position] In my reasoning, relevant actors are Third Nations, i.e., states other than the Great Powers. Within this category, small states face the sharpest constraints, while middle powers possess greater resources and convening capacity.  What all such nations share, however, is an inability individually to dictate the rules of international order.
3. [Position] G-minus describes institutions designed to remain functional when any particular Great Power declines to participate, withdraws support, or actively obstructs cooperation. Great Powers may join and contribute; however, their companionship, permission, and underwriting are not constitutive requirements.
4. [Position] I propose the term "economic diplomacy" as the Third-Nation counterpart to Great-Power economic statecraft.
 a. [Position] Economic diplomacy is the use of economic instruments and relationships by states unable to dictate system-wide outcomes, in order to preserve policy space, build resilience and prosperity, aggregate influence, and minimise unnecessary hostility---especially from Great Powers.
 e. [Position] My primary framework for economic diplomacy is built around 3As:  Acquiescence.  Adaptation.  Aggregation.   Acquiescence is symbolic yielding on the axis of contention, while quietly building institutions elsewhere.  Adaptation is domestic restructuring for increased resilience.  Aggregation is outward coalition-building.  The 3As are strategic modalities, not mutually exclusive choices. A state normally constructs a portfolio across them, differing by issue, counterparty, and time horizon. (My earlier writings used instead a different 3As: Alignment, Acquiescence, and Adaptation and Mitigation, or yet some other combination.  For now, I am settling on what appears in the unparenthesised part of this item.)
5. [Open question] With the retreat of rules-based multilateral order, how do best-response international strategies change?
 a. [Position] Under rules-based multilateralism, Third Nation strategy was conceptually straightforward: behave as a price-taker and, through that, achieve efficient income growth, stability, and economic performance.  Now, however, states must optimise across prosperity, economic security, and national security, recognising complementarities as well as trade-offs and distinguishing ultimate objectives from the instruments used to pursue them.
 b. [Position] I have argued that Third Nations need to stop asking where global leadership will next come from, but instead learn to work in a *G-minus* world.
 c. ([Open question] As an aside in this work I also research how to conceptualise these different notions of security.)
...
<!--
   Invisible section // Intellectual-framework-2026.09.md
-->
